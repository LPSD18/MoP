...
public abstract class Evento {
	...
	/**
	 * Retorna uma String contendo informações sobre o Evento. Nota: Ver o ficheiro
	...
	/**
	 * Escreve, para a consola, o prefixo seguido da String representativa do
	 * Evento.
	 * 
	 * @param prefix - Um prefixo para gerar a identação apropriada de acordo com a
	 *               "profundidade".
	 */
	...
	/**
	 * Constroi um novo Evento (Espetáculo ou Festival) a partir das informações
	 * existentes no nó nNode que foi lido da arvore XML.
	 * 
